...
gee1 <- geeglm(response ~ treatment + month, id = id, data = toenail_1, family = binomial(link = "logit"), corstr = "unstructured")
summary(gee1)
```
...
gee2 <- geeglm(response ~ treatment + month, id = id, data = toenail2, family = binomial(link = "logit"), corstr = "unstructured")
